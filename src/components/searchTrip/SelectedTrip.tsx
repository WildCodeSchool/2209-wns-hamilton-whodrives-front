...
function SelectedTrip({ départ, arrivée, place, prix,date,onClick }: PropsSelectedTrip) {
  return (
    <div className="w-screen h-1/1  font-bold">
      <div
      ...
      <div className="w-3/5 border h-1/1 flex flex-row pl-10 pr-10 ml-auto mr-auto p-4 ">
