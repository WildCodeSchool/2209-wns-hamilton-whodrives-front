...
function CreateTripPage(): JSX.Element {
  ...
  const steps = ['création de trajet', 'confirmation du trajet', 'trajet retour','confirmation du trajet retour&', 'publication du trajet'];
    ...
    function getStepContent(step: number) {
      switch (step) {
        case 0:
          ...
          return <LocationField trip={trip} handleLocationFieldData={handleLocationFieldData} />;
        case 1:
